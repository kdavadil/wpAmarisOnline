...
define('FLOWER_SHOP_LITE_SKTTHEMES_URL','https://www.sktthemes.net','flower-shop-lite');
define('FLOWER_SHOP_LITE_SKTTHEMES_PRO_THEME_URL','https://www.sktthemes.net/shop/florist-wordpress-theme/','flower-shop-lite');
define('FLOWER_SHOP_LITE_SKTTHEMES_FREE_THEME_URL','https://www.sktthemes.net/shop/free-shop-wordpress-theme/','flower-shop-lite');
define('FLOWER_SHOP_LITE_SKTTHEMES_THEME_DOC','http://sktthemesdemo.net/documentation/flower-documentation/','flower-shop-lite');
define('FLOWER_SHOP_LITE_SKTTHEMES_LIVE_DEMO','http://sktperfectdemo.com/demos/flowershop/','flower-shop-lite');
define('FLOWER_SHOP_LITE_SKTTHEMES_THEMES','https://www.sktthemes.net/themes/','flower-shop-lite');
...
add_filter( 'woocommerce_add_to_cart_fragments', 'flower_shop_lite_woocommerce_header_add_to_cart_fragment' );
function flower_shop_lite_woocommerce_header_add_to_cart_fragment( $fragments ) {
    ob_start();
    ?>
    <a class="cart-contents" href="<?php echo esc_url(wc_get_cart_url()); ?>" title="<?php esc_attr_e('View your shopping cart', 'flower-shop-lite'); ?>">
        ...
        <span class="prd-count"><?php echo sprintf ('%d', '%d', WC()->cart->get_cart_contents_count()), WC()->cart->get_cart_contents_count();?></span>
        <span class="prd-amount"><?php echo WC()->cart->get_cart_total(); ?></span>
        <div class="clear"></div>
        </a>
    <?php
